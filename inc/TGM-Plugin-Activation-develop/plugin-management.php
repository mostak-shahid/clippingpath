...
add_action( 'tgmpa_register', 'clippingpath_plugins_management' );
...
function clippingpath_plugins_management() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'				=> 'Formidable Form Builder – Contact Form, Survey & Quiz Forms Plugin for WordPress', 
			'slug'				=> 'formidable', 
			'required'			=> false,
			'force_activation'	=> false, 
		),
